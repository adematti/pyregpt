...
CUBA_INC = $(CUBA)
CUBA_LIB = $(CUBA)
CUBA_OBJ = $(CUBA)/Vegas.o $(CUBA)/Suave.o
REGPT_LIB = ./lib
...
CPKCORR_A_I = $(REGPT_LIB)/calc_pkcorr_from_A_I.c
CPKCORR_A_II_III = $(REGPT_LIB)/calc_pkcorr_from_A_II_III.c
CSPECTRUM_A_2LOOP = $(REGPT_LIB)/spectrum_A_2loop.c

CPKCORR_B = $(REGPT_LIB)/calc_pkcorr_from_B.c
CSPECTRUM_B = $(REGPT_LIB)/spectrum_B.c

CPKCORR_BIAS = $(REGPT_LIB)/calc_pkcorr_from_bias.c
CSPECTRUM_BIAS = $(REGPT_LIB)/spectrum_bias.c

SRC = $(CREGPT) $(CCOMMON) $(CKERNELS) $(CGAMMA1_1LOOP) $(CGAMMA1_2LOOP) $(CGAMMA2d_1LOOP) $(CGAMMA2t_1LOOP) $(CPKCORR_GAMMA1) $(CPKCORR_GAMMA2) $(CPKCORR_GAMMA3) $(CSPECTRUM_1LOOP) $(CSPECTRUM_2LOOP) $(CBISPECTRUM_1LOOP) $(CPKCORR_A_I) $(CPKCORR_A_II_III) $(CSPECTRUM_A_2LOOP) $(CPKCORR_B) $(CSPECTRUM_B) $(CPKCORR_BIAS) $(CSPECTRUM_BIAS)
